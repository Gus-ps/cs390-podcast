...
async function generateScript(articles) {
    ...
    try {
        ...
        const filepath = helpers.saveTextFile(script, 'podcast-script.txt');
        return filepath;
...
async function generateAudio(text) {
    ...
    try {
        ...
        const voiceId = process.env.PODCAST_VOICE_ID;
...
async function generatePodcast() {
    ...
    try {
        ...
        const requiredVars = [process.env.NEWS_API_KEY, process.env.OPENAI_API_KEY, process.env.ELEVENLABS_API_KEY];
        ...
        const script = generateScript(articles);
